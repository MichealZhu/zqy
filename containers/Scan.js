        ...
        return (
          ...
          <View style={styles.container}>
            ...
            <View style={{flex:1,backgroundColor:'rgba(0, 0, 0, 0.5)',width:width,alignItems:'center'}}>
              <Text style={styles.textStyle}>将二维码/条形码放入框内,即可自动扫描</Text>
            </View>
        ...
        return(
            <View style={styles.navBarStyle}>
                <TouchableOpacity
                    ...
                    <Image source={{uri:'../images/1.jpg'}}
                           style={{height:20,width:20}} />
                </TouchableOpacity>
                <Text style={[styles.navTitleStyle,{marginTop:Platform.OS == 'ios'?12:0,fontSize:15}]}>
                    二维码/条形码
                </Text>
            </View>
        )
